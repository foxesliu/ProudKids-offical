!function (t, i) {
    ...
    return t.fn.Paging = function (i) {
        ...
        init: function (i) {
            ...
            var i = "<ul>";
            if (i += '<li class=\'p-page-size\' onclick="changePageSize(this)"><span>显示10条</span><i class="arc-up"></i><ul class="hidden"><li>50条</li><li>30条</li><li>20条</li><li>10条</li></ul></li><li class="js-page-first js-page-action ui-pager" >' + this.settings.firstTpl + "</li>", i += '<li class="js-page-prev js-page-action ui-pager">' + this.settings.prevTpl + "</li>", this.pagecount > 6) {
